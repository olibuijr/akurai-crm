        ...
        Self {
            ...
            fields: vec![
                ...
                FieldMetadata {
                    ...
                    description: Some("Related company".into()),
                    is_required: false,
                    is_unique: false,
                    is_custom: false,
                    default_value: None,
        ...
        Self {
            ...
            fields: vec![
                ...
                FieldMetadata {
                    ...
                    description: Some("Pipeline stage".into()),
                    is_required: true,
                    is_unique: false,
                    is_custom: false,
                    default_value: Some(Value::Str("new".into())),
                    options: vec![
                        FieldOption {
                            label: "New".into(),
                            value: "new".into(),
                        ...
                        FieldOption {
                            ...
                            value: "screening".into(),
                            color: Some("#60a5fa".into()),
                        },
                        FieldOption {
                            label: "Meeting".into(),
                            value: "meeting".into(),
                            color: Some("#818cf8".into()),
                        },
                        FieldOption {
                            label: "Proposal".into(),
                            value: "proposal".into(),
                        ...
                        FieldOption {
                            label: "Negotiation".into(),
                            value: "negotiation".into(),
                ...
                FieldMetadata {
                    ...
                    field_type: FieldType::Number,
                    description: Some("Win probability (%)".into()),
                    is_required: false,
                    is_unique: false,
                    is_custom: false,
                    default_value: None,
        ...
        Self {
            ...
            fields: vec![
                ...
                FieldMetadata {
                    ...
                    is_unique: false,
                    is_custom: false,
                    default_value: Some(Value::Str("todo".into())),
                    options: vec![
                        FieldOption {
                            label: "Todo".into(),
                            value: "todo".into(),
